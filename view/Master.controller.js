sap.ui.core.mvc.Controller.extend("Variantconf.view.Master", {
	...
	loadDetailView : function(){
		this.getRouter().myNavToWithoutHash({ 
			...
			targetViewName : "Variantconf.view.Detail",
			targetViewType : "XML"
		});
	},
	...
	onSearch : function() {
		...
		if (searchString && searchString.length > 0) {
			filters = [ new sap.ui.model.Filter("ATNAM", sap.ui.model.FilterOperator.Contains, searchString) ];
		}
		// Update list binding
